            ...
            $wnd.jQuery.extend(true, this, 
            {
                events: {
                    afterAnimate: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.option.api.plotoptions.arearange.ArearangeAfterAnimateHandler::onArearangeAfterAnimate(Lcom/github/highcharts4gwt/model/highcharts/option/api/plotoptions/arearange/ArearangeAfterAnimateEvent;)(
            ...
            $wnd.jQuery.extend(true, this, 
            {
                events: {
                    checkboxClick: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.option.api.plotoptions.arearange.ArearangeCheckboxClickHandler::onArearangeCheckboxClick(Lcom/github/highcharts4gwt/model/highcharts/option/api/plotoptions/arearange/ArearangeCheckboxClickEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
            ...
            $wnd.jQuery.extend(true, this, 
            {
                events: {
                    click: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.option.api.plotoptions.arearange.ArearangeClickHandler::onArearangeClick(Lcom/github/highcharts4gwt/model/highcharts/option/api/plotoptions/arearange/ArearangeClickEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
    ...
    public final native void addArearangeHideHandler(ArearangeHideHandler handler)
        ...
        /*-{
            $wnd.jQuery.extend(true, this, 
            {
                events: {
                    hide: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.option.api.plotoptions.arearange.ArearangeHideHandler::onArearangeHide(Lcom/github/highcharts4gwt/model/highcharts/option/api/plotoptions/arearange/ArearangeHideEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
            ...
            $wnd.jQuery.extend(true, this, 
            {
                events: {
                    legendItemClick: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.option.api.plotoptions.arearange.ArearangeLegendItemClickHandler::onArearangeLegendItemClick(Lcom/github/highcharts4gwt/model/highcharts/option/api/plotoptions/arearange/ArearangeLegendItemClickEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
            ...
            $wnd.jQuery.extend(true, this, 
            {
                events: {
                    mouseOut: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.option.api.plotoptions.arearange.ArearangeMouseOutHandler::onArearangeMouseOut(Lcom/github/highcharts4gwt/model/highcharts/option/api/plotoptions/arearange/ArearangeMouseOutEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
            ...
            $wnd.jQuery.extend(true, this, 
            {
                events: {
                    mouseOver: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.option.api.plotoptions.arearange.ArearangeMouseOverHandler::onArearangeMouseOver(Lcom/github/highcharts4gwt/model/highcharts/option/api/plotoptions/arearange/ArearangeMouseOverEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
    ...
    public final native void addArearangeShowHandler(ArearangeShowHandler handler)
        ...
        /*-{
            $wnd.jQuery.extend(true, this, 
            {
                events: {
                    show: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.option.api.plotoptions.arearange.ArearangeShowHandler::onArearangeShow(Lcom/github/highcharts4gwt/model/highcharts/option/api/plotoptions/arearange/ArearangeShowEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
