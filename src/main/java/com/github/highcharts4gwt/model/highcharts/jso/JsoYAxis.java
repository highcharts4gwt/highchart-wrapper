...
import com.github.highcharts4gwt.model.highcharts.jso.JsoXAxis;
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    axisAfterSetExtremes: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.yaxis.YAxisAfterSetExtremesHandler::onYAxisAfterSetExtremes(Lcom/github/highcharts4gwt/model/highcharts/api/yaxis/YAxisAfterSetExtremesEvent;)(
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    axisSetExtremes: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.yaxis.YAxisSetExtremesHandler::onYAxisSetExtremes(Lcom/github/highcharts4gwt/model/highcharts/api/yaxis/YAxisSetExtremesEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
