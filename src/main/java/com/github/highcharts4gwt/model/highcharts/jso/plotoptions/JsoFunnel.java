...
import com.github.highcharts4gwt.model.highcharts.api.plotoptions.funnel.DataLabels;
...
import com.github.highcharts4gwt.model.highcharts.api.plotoptions.funnel.States;
import com.github.highcharts4gwt.model.highcharts.api.plotoptions.funnel.Tooltip;
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    afterAnimate: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.funnel.FunnelAfterAnimateHandler::onFunnelAfterAnimate(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/funnel/FunnelAfterAnimateEvent;)(
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    checkboxClick: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.funnel.FunnelCheckboxClickHandler::onFunnelCheckboxClick(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/funnel/FunnelCheckboxClickEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    click: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.funnel.FunnelClickHandler::onFunnelClick(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/funnel/FunnelClickEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
    ...
    public final native void addFunnelHideHandler(FunnelHideHandler handler)
        ...
        /*-{
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    hide: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.funnel.FunnelHideHandler::onFunnelHide(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/funnel/FunnelHideEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    legendItemClick: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.funnel.FunnelLegendItemClickHandler::onFunnelLegendItemClick(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/funnel/FunnelLegendItemClickEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    mouseOut: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.funnel.FunnelMouseOutHandler::onFunnelMouseOut(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/funnel/FunnelMouseOutEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    mouseOver: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.funnel.FunnelMouseOverHandler::onFunnelMouseOver(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/funnel/FunnelMouseOverEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
    ...
    public final native void addFunnelShowHandler(FunnelShowHandler handler)
        ...
        /*-{
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    show: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.funnel.FunnelShowHandler::onFunnelShow(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/funnel/FunnelShowEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
