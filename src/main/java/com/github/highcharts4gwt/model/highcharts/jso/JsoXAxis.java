            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    axisAfterSetExtremes: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.xaxis.XAxisAfterSetExtremesHandler::onXAxisAfterSetExtremes(Lcom/github/highcharts4gwt/model/highcharts/api/xaxis/XAxisAfterSetExtremesEvent;)(
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    axisSetExtremes: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.xaxis.XAxisSetExtremesHandler::onXAxisSetExtremes(Lcom/github/highcharts4gwt/model/highcharts/api/xaxis/XAxisSetExtremesEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
