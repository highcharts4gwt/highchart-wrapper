            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    afterAnimate: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.area.AreaAfterAnimateHandler::onAreaAfterAnimate(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/area/AreaAfterAnimateEvent;)(
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    checkboxClick: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.area.AreaCheckboxClickHandler::onAreaCheckboxClick(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/area/AreaCheckboxClickEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    click: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.area.AreaClickHandler::onAreaClick(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/area/AreaClickEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
    ...
    public final native void addAreaHideHandler(AreaHideHandler handler)
        ...
        /*-{
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    hide: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.area.AreaHideHandler::onAreaHide(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/area/AreaHideEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    legendItemClick: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.area.AreaLegendItemClickHandler::onAreaLegendItemClick(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/area/AreaLegendItemClickEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    mouseOut: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.area.AreaMouseOutHandler::onAreaMouseOut(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/area/AreaMouseOutEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    mouseOver: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.area.AreaMouseOverHandler::onAreaMouseOver(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/area/AreaMouseOverEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
    ...
    public final native void addAreaShowHandler(AreaShowHandler handler)
        ...
        /*-{
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    show: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.area.AreaShowHandler::onAreaShow(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/area/AreaShowEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
