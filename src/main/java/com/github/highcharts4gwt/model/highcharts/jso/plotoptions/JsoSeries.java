            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    afterAnimate: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.series.SeriesAfterAnimateHandler::onSeriesAfterAnimate(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/series/SeriesAfterAnimateEvent;)(
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    checkboxClick: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.series.SeriesCheckboxClickHandler::onSeriesCheckboxClick(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/series/SeriesCheckboxClickEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    click: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.series.SeriesClickHandler::onSeriesClick(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/series/SeriesClickEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
    ...
    public final native void addSeriesHideHandler(SeriesHideHandler handler)
        ...
        /*-{
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    hide: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.series.SeriesHideHandler::onSeriesHide(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/series/SeriesHideEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    legendItemClick: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.series.SeriesLegendItemClickHandler::onSeriesLegendItemClick(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/series/SeriesLegendItemClickEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    mouseOut: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.series.SeriesMouseOutHandler::onSeriesMouseOut(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/series/SeriesMouseOutEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    mouseOver: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.series.SeriesMouseOverHandler::onSeriesMouseOver(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/series/SeriesMouseOverEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
    ...
    public final native void addSeriesShowHandler(SeriesShowHandler handler)
        ...
        /*-{
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    show: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.series.SeriesShowHandler::onSeriesShow(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/series/SeriesShowEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
