...
import com.github.highcharts4gwt.model.highcharts.option.api.seriesline.FormatterCallback;
    ...
    implements DataLabels
{
    ...
    public final native JsoDataLabels formatter(FormatterCallback formatter)
        throws RuntimeException 
            ...
            {
                formatter: function() {
                    return formatter.@com.github.highcharts4gwt.model.highcharts.option.api.seriesline.FormatterCallback::onCallback()(
