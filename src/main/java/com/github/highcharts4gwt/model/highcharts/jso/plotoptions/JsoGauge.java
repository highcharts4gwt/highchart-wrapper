            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    afterAnimate: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.gauge.GaugeAfterAnimateHandler::onGaugeAfterAnimate(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/gauge/GaugeAfterAnimateEvent;)(
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    checkboxClick: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.gauge.GaugeCheckboxClickHandler::onGaugeCheckboxClick(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/gauge/GaugeCheckboxClickEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    click: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.gauge.GaugeClickHandler::onGaugeClick(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/gauge/GaugeClickEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
    ...
    public final native void addGaugeHideHandler(GaugeHideHandler handler)
        ...
        /*-{
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    hide: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.gauge.GaugeHideHandler::onGaugeHide(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/gauge/GaugeHideEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    legendItemClick: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.gauge.GaugeLegendItemClickHandler::onGaugeLegendItemClick(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/gauge/GaugeLegendItemClickEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    mouseOut: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.gauge.GaugeMouseOutHandler::onGaugeMouseOut(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/gauge/GaugeMouseOutEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    mouseOver: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.gauge.GaugeMouseOverHandler::onGaugeMouseOver(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/gauge/GaugeMouseOverEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
    ...
    public final native void addGaugeShowHandler(GaugeShowHandler handler)
        ...
        /*-{
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    show: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.gauge.GaugeShowHandler::onGaugeShow(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/gauge/GaugeShowEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
