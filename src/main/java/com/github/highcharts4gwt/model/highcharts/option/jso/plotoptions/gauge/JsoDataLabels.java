...
import com.github.highcharts4gwt.model.highcharts.option.api.plotoptions.gauge.FormatterCallback;
    ...
    implements DataLabels
{
    ...
    public final native JsoDataLabels formatter(FormatterCallback formatter)
        throws RuntimeException 
            ...
            {
                formatter: function() {
                    return formatter.@com.github.highcharts4gwt.model.highcharts.option.api.plotoptions.gauge.FormatterCallback::onCallback()(
