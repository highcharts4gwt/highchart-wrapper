            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    addSeries: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.chart.ChartAddSeriesHandler::onChartAddSeries(Lcom/github/highcharts4gwt/model/highcharts/api/chart/ChartAddSeriesEvent;)(
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    click: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.chart.ChartClickHandler::onChartClick(Lcom/github/highcharts4gwt/model/highcharts/api/chart/ChartClickEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    drilldown: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.chart.ChartDrilldownHandler::onChartDrilldown(Lcom/github/highcharts4gwt/model/highcharts/api/chart/ChartDrilldownEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    drillup: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.chart.ChartDrillupHandler::onChartDrillup(Lcom/github/highcharts4gwt/model/highcharts/api/chart/ChartDrillupEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
    ...
    public final native void addChartLoadHandler(ChartLoadHandler handler)
        ...
        /*-{
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    load: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.chart.ChartLoadHandler::onChartLoad(Lcom/github/highcharts4gwt/model/highcharts/api/chart/ChartLoadEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    redraw: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.chart.ChartRedrawHandler::onChartRedraw(Lcom/github/highcharts4gwt/model/highcharts/api/chart/ChartRedrawEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    selection: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.chart.ChartSelectionHandler::onChartSelection(Lcom/github/highcharts4gwt/model/highcharts/api/chart/ChartSelectionEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
