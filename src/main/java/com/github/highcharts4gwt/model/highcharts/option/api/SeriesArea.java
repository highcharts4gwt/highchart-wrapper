...
import com.github.highcharts4gwt.model.highcharts.option.api.seriesarea.SeriesAreaAfterAnimateHandler;
import com.github.highcharts4gwt.model.highcharts.option.api.seriesarea.SeriesAreaCheckboxClickHandler;
import com.github.highcharts4gwt.model.highcharts.option.api.seriesarea.SeriesAreaClickHandler;
import com.github.highcharts4gwt.model.highcharts.option.api.seriesarea.SeriesAreaHideHandler;
import com.github.highcharts4gwt.model.highcharts.option.api.seriesarea.SeriesAreaLegendItemClickHandler;
import com.github.highcharts4gwt.model.highcharts.option.api.seriesarea.SeriesAreaMouseOutHandler;
import com.github.highcharts4gwt.model.highcharts.option.api.seriesarea.SeriesAreaMouseOverHandler;
import com.github.highcharts4gwt.model.highcharts.option.api.seriesarea.SeriesAreaShowHandler;
...
public interface SeriesArea {
     ...
     * 
     */
    SeriesArea allowPointSelect(boolean allowPointSelect);
     ...
     * 
     */
    SeriesArea animation(boolean animation);
     ...
     * 
     */
    SeriesArea connectEnds(boolean connectEnds);
     ...
     * 
     */
    SeriesArea connectNulls(boolean connectNulls);
     ...
     * 
     */
    SeriesArea cropThreshold(double cropThreshold);
     ...
     * 
     */
    SeriesArea cursor(String cursor);
     ...
     * 
     */
    SeriesArea dashStyle(String dashStyle);
     ...
     * 
     */
    SeriesArea dataAsArrayObject(Array<Data> dataAsArrayObject);
     ...
     * 
     */
    SeriesArea dataAsArrayNumber(ArrayNumber dataAsArrayNumber);
     ...
     * 
     */
    SeriesArea enableMouseTracking(boolean enableMouseTracking);

    void addSeriesAreaAfterAnimateHandler(SeriesAreaAfterAnimateHandler seriesAreaAfterAnimateHandler);

    void addSeriesAreaCheckboxClickHandler(SeriesAreaCheckboxClickHandler seriesAreaCheckboxClickHandler);

    void addSeriesAreaClickHandler(SeriesAreaClickHandler seriesAreaClickHandler);

    void addSeriesAreaHideHandler(SeriesAreaHideHandler seriesAreaHideHandler);

    void addSeriesAreaLegendItemClickHandler(SeriesAreaLegendItemClickHandler seriesAreaLegendItemClickHandler);

    void addSeriesAreaMouseOutHandler(SeriesAreaMouseOutHandler seriesAreaMouseOutHandler);

    void addSeriesAreaMouseOverHandler(SeriesAreaMouseOverHandler seriesAreaMouseOverHandler);

    void addSeriesAreaShowHandler(SeriesAreaShowHandler seriesAreaShowHandler);
     ...
     * 
     */
    SeriesArea fillColor(String fillColor);
     ...
     * 
     */
    SeriesArea fillOpacity(double fillOpacity);
     ...
     * 
     */
    SeriesArea keys(ArrayString keys);
     ...
     * 
     */
    SeriesArea legendIndex(double legendIndex);
     ...
     * 
     */
    SeriesArea lineColor(String lineColor);
     ...
     * 
     */
    SeriesArea lineWidth(double lineWidth);
     ...
     * 
     */
    SeriesArea linkedTo(String linkedTo);
     ...
     * 
     */
    SeriesArea negativeColor(String negativeColor);
     ...
     * 
     */
    SeriesArea negativeFillColor(String negativeFillColor);
     ...
     * 
     */
    SeriesArea pointInterval(double pointInterval);
     ...
     * 
     */
    SeriesArea pointIntervalUnit(String pointIntervalUnit);
     ...
     * 
     */
    SeriesArea pointPlacementAsString(String pointPlacementAsString);
     ...
     * 
     */
    SeriesArea pointPlacementAsNumber(double pointPlacementAsNumber);
     ...
     * 
     */
    SeriesArea pointStart(double pointStart);
     ...
     * 
     */
    SeriesArea selected(boolean selected);
     ...
     * 
     */
    SeriesArea shadowAsBoolean(boolean shadowAsBoolean);
     ...
     * 
     */
    SeriesArea shadowAsJsonString(String shadowAsJsonString);
     ...
     * 
     */
    SeriesArea showCheckbox(boolean showCheckbox);
     ...
     * 
     */
    SeriesArea showInLegend(boolean showInLegend);
     ...
     * 
     */
    SeriesArea stacking(String stacking);
     ...
     * 
     */
    SeriesArea stickyTracking(boolean stickyTracking);
     ...
     * 
     */
    SeriesArea threshold(double threshold);
     ...
     * 
     */
    SeriesArea tooltip(Tooltip tooltip);
     ...
     * 
     */
    SeriesArea trackByArea(boolean trackByArea);
     ...
     * 
     */
    SeriesArea turboThreshold(double turboThreshold);
     ...
     * 
     */
    SeriesArea visible(boolean visible);
     ...
     * 
     */
    SeriesArea xAxisAsNumber(double xAxisAsNumber);
     ...
     * 
     */
    SeriesArea xAxisAsString(String xAxisAsString);
     ...
     * 
     */
    SeriesArea yAxisAsNumber(double yAxisAsNumber);
     ...
     * 
     */
    SeriesArea yAxisAsString(String yAxisAsString);
     ...
     * 
     */
    SeriesArea zIndex(double zIndex);
     ...
     * 
     */
    SeriesArea zoneAxis(String zoneAxis);
     ...
     * 
     */
    SeriesArea zones(ArrayNumber zones);

    String getFieldAsJsonObject(String fieldName);

    SeriesArea setFieldAsJsonObject(String fieldName, String fieldValueAsJonObject);

    String getFunctionAsString(String fieldName);

    SeriesArea setFunctionAsString(String fieldName, String functionAsString);
