    ...
    implements Arearange
{
    ...
    public MockArearange keys(ArrayString keys) {
        this.keys = keys;
        return this;
    }
    ...
    public MockArearange setFieldAsJsonObject(String fieldName, String fieldValueAsJsonObject) {
    ...
    public MockArearange setFunctionAsString(String fieldName, String functionAsString) {
