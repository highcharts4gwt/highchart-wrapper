...
public interface SeriesBar {
     ...
     * 
     */
    SeriesBar allowPointSelect(boolean allowPointSelect);
     ...
     * 
     */
    SeriesBar animation(boolean animation);
     ...
     * 
     */
    SeriesBar borderColor(String borderColor);
     ...
     * 
     */
    SeriesBar borderRadius(double borderRadius);
     ...
     * 
     */
    SeriesBar borderWidth(double borderWidth);
     ...
     * 
     */
    SeriesBar colorByPoint(boolean colorByPoint);
     ...
     * 
     */
    SeriesBar colors(ArrayString colors);
     ...
     * 
     */
    SeriesBar cropThreshold(double cropThreshold);
     ...
     * 
     */
    SeriesBar cursor(String cursor);
     ...
     * 
     */
    SeriesBar dataAsArrayObject(Array<Data> dataAsArrayObject);
     ...
     * 
     */
    SeriesBar dataAsArrayNumber(ArrayNumber dataAsArrayNumber);
     ...
     * 
     */
    SeriesBar edgeColor(String edgeColor);
     ...
     * 
     */
    SeriesBar edgeWidth(double edgeWidth);
     ...
     * 
     */
    SeriesBar enableMouseTracking(boolean enableMouseTracking);

    void addSeriesBarAfterAnimateHandler(SeriesBarAfterAnimateHandler seriesBarAfterAnimateHandler);

    void addSeriesBarCheckboxClickHandler(SeriesBarCheckboxClickHandler seriesBarCheckboxClickHandler);

    void addSeriesBarClickHandler(SeriesBarClickHandler seriesBarClickHandler);

    void addSeriesBarHideHandler(SeriesBarHideHandler seriesBarHideHandler);

    void addSeriesBarLegendItemClickHandler(SeriesBarLegendItemClickHandler seriesBarLegendItemClickHandler);

    void addSeriesBarMouseOutHandler(SeriesBarMouseOutHandler seriesBarMouseOutHandler);

    void addSeriesBarMouseOverHandler(SeriesBarMouseOverHandler seriesBarMouseOverHandler);

    void addSeriesBarShowHandler(SeriesBarShowHandler seriesBarShowHandler);
     ...
     * 
     */
    SeriesBar groupPadding(double groupPadding);
     ...
     * 
     */
    SeriesBar groupZPadding(double groupZPadding);
     ...
     * 
     */
    SeriesBar grouping(boolean grouping);
     ...
     * 
     */
    SeriesBar keys(ArrayString keys);
     ...
     * 
     */
    SeriesBar legendIndex(double legendIndex);
     ...
     * 
     */
    SeriesBar linkedTo(String linkedTo);
     ...
     * 
     */
    SeriesBar minPointLength(double minPointLength);
     ...
     * 
     */
    SeriesBar negativeColor(String negativeColor);
     ...
     * 
     */
    SeriesBar pointInterval(double pointInterval);
     ...
     * 
     */
    SeriesBar pointIntervalUnit(String pointIntervalUnit);
     ...
     * 
     */
    SeriesBar pointPadding(double pointPadding);
     ...
     * 
     */
    SeriesBar pointPlacementAsString(String pointPlacementAsString);
     ...
     * 
     */
    SeriesBar pointPlacementAsNumber(double pointPlacementAsNumber);
     ...
     * 
     */
    SeriesBar pointRange(double pointRange);
     ...
     * 
     */
    SeriesBar pointStart(double pointStart);
     ...
     * 
     */
    SeriesBar pointWidth(double pointWidth);
     ...
     * 
     */
    SeriesBar selected(boolean selected);
     ...
     * 
     */
    SeriesBar shadowAsBoolean(boolean shadowAsBoolean);
     ...
     * 
     */
    SeriesBar shadowAsJsonString(String shadowAsJsonString);
     ...
     * 
     */
    SeriesBar showCheckbox(boolean showCheckbox);
     ...
     * 
     */
    SeriesBar showInLegend(boolean showInLegend);
     ...
     * 
     */
    SeriesBar stacking(String stacking);
     ...
     * 
     */
    SeriesBar stickyTracking(boolean stickyTracking);
     ...
     * 
     */
    SeriesBar threshold(double threshold);
     ...
     * 
     */
    SeriesBar tooltip(Tooltip tooltip);
     ...
     * 
     */
    SeriesBar turboThreshold(double turboThreshold);
     ...
     * 
     */
    SeriesBar visible(boolean visible);
     ...
     * 
     */
    SeriesBar xAxisAsNumber(double xAxisAsNumber);
     ...
     * 
     */
    SeriesBar xAxisAsString(String xAxisAsString);
     ...
     * 
     */
    SeriesBar yAxisAsNumber(double yAxisAsNumber);
     ...
     * 
     */
    SeriesBar yAxisAsString(String yAxisAsString);
     ...
     * 
     */
    SeriesBar zIndex(double zIndex);
     ...
     * 
     */
    SeriesBar zoneAxis(String zoneAxis);
     ...
     * 
     */
    SeriesBar zones(ArrayNumber zones);

    String getFieldAsJsonObject(String fieldName);

    SeriesBar setFieldAsJsonObject(String fieldName, String fieldValueAsJonObject);

    String getFunctionAsString(String fieldName);

    SeriesBar setFunctionAsString(String fieldName, String functionAsString);
