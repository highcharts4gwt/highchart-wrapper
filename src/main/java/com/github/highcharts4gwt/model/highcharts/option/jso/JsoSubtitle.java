    ...
    implements Subtitle
{
    ...
    public final native JsoSubtitle setFieldAsJsonObject(String fieldName, String fieldValueAsJsonObject)
        throws RuntimeException /*-{
    ...
    public final native JsoSubtitle setFunctionAsString(String fieldName, String functionAsString)
        throws RuntimeException /*-{
