            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    afterAnimate: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.pie.PieAfterAnimateHandler::onPieAfterAnimate(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/pie/PieAfterAnimateEvent;)(
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    checkboxClick: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.pie.PieCheckboxClickHandler::onPieCheckboxClick(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/pie/PieCheckboxClickEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    click: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.pie.PieClickHandler::onPieClick(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/pie/PieClickEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
    ...
    public final native void addPieHideHandler(PieHideHandler handler)
        ...
        /*-{
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    hide: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.pie.PieHideHandler::onPieHide(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/pie/PieHideEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    legendItemClick: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.pie.PieLegendItemClickHandler::onPieLegendItemClick(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/pie/PieLegendItemClickEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    mouseOut: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.pie.PieMouseOutHandler::onPieMouseOut(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/pie/PieMouseOutEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
            ...
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    mouseOver: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.pie.PieMouseOverHandler::onPieMouseOver(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/pie/PieMouseOverEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
    ...
    public final native void addPieShowHandler(PieShowHandler handler)
        ...
        /*-{
            return $wnd.jQuery.extend(true, this, 
            {
                events: {
                    show: function(event) {
                        handler.@com.github.highcharts4gwt.model.highcharts.api.plotoptions.pie.PieShowHandler::onPieShow(Lcom/github/highcharts4gwt/model/highcharts/api/plotoptions/pie/PieShowEvent;)(
                            $wnd.jQuery.extend(true, event, {source:this})
                         );
                     }
                 }
