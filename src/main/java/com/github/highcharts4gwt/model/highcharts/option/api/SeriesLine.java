...
public interface SeriesLine {
     ...
     * 
     */
    SeriesLine allowPointSelect(boolean allowPointSelect);
     ...
     * 
     */
    SeriesLine animation(boolean animation);
     ...
     * 
     */
    SeriesLine connectEnds(boolean connectEnds);
     ...
     * 
     */
    SeriesLine connectNulls(boolean connectNulls);
     ...
     * 
     */
    SeriesLine cropThreshold(double cropThreshold);
     ...
     * 
     */
    SeriesLine cursor(String cursor);
     ...
     * 
     */
    SeriesLine dashStyle(String dashStyle);
     ...
     * 
     */
    SeriesLine dataAsArrayObject(Array<Data> dataAsArrayObject);
     ...
     * 
     */
    SeriesLine dataAsArrayNumber(ArrayNumber dataAsArrayNumber);
     ...
     * 
     */
    SeriesLine keys(ArrayString keys);
     ...
     * 
     */
    SeriesLine legendIndex(double legendIndex);
     ...
     * 
     */
    SeriesLine lineWidth(double lineWidth);
     ...
     * 
     */
    SeriesLine linkedTo(String linkedTo);
     ...
     * 
     */
    SeriesLine negativeColor(String negativeColor);
     ...
     * 
     */
    SeriesLine pointInterval(double pointInterval);
     ...
     * 
     */
    SeriesLine pointIntervalUnit(String pointIntervalUnit);
     ...
     * 
     */
    SeriesLine pointPlacementAsString(String pointPlacementAsString);
     ...
     * 
     */
    SeriesLine pointPlacementAsNumber(double pointPlacementAsNumber);
     ...
     * 
     */
    SeriesLine pointStart(double pointStart);
     ...
     * 
     */
    SeriesLine selected(boolean selected);
     ...
     * 
     */
    SeriesLine shadowAsBoolean(boolean shadowAsBoolean);
     ...
     * 
     */
    SeriesLine shadowAsJsonString(String shadowAsJsonString);
     ...
     * 
     */
    SeriesLine showCheckbox(boolean showCheckbox);
     ...
     * 
     */
    SeriesLine showInLegend(boolean showInLegend);
     ...
     * 
     */
    SeriesLine stacking(String stacking);
     ...
     * 
     */
    SeriesLine stickyTracking(boolean stickyTracking);
     ...
     * 
     */
    SeriesLine threshold(double threshold);
     ...
     * 
     */
    SeriesLine tooltip(Tooltip tooltip);
     ...
     * 
     */
    SeriesLine turboThreshold(double turboThreshold);
     ...
     * 
     */
    SeriesLine visible(boolean visible);
     ...
     * 
     */
    SeriesLine xAxisAsNumber(double xAxisAsNumber);
     ...
     * 
     */
    SeriesLine xAxisAsString(String xAxisAsString);
     ...
     * 
     */
    SeriesLine yAxisAsNumber(double yAxisAsNumber);
     ...
     * 
     */
    SeriesLine yAxisAsString(String yAxisAsString);
     ...
     * 
     */
    SeriesLine zIndex(double zIndex);
     ...
     * 
     */
    SeriesLine zoneAxis(String zoneAxis);
     ...
     * 
     */
    SeriesLine zones(ArrayNumber zones);

    String getFieldAsJsonObject(String fieldName);

    SeriesLine setFieldAsJsonObject(String fieldName, String fieldValueAsJonObject);

    String getFunctionAsString(String fieldName);

    SeriesLine setFunctionAsString(String fieldName, String functionAsString);
